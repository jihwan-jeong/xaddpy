"""
This file is necessary for the QPTL method
The code is a direct copy of
    https://github.com/JayMan91/NeurIPSIntopt/blob/main/Interior/qpthlocal/qp.py
"""

import torch
from torch.autograd import Function

from xaddpy.models.util.util import bger, expandParam, extract_nBatch
from xaddpy.models.util.solvers import cvxpy
from xaddpy.models.util.solvers.pdipm import batch as pdipm_b
from xaddpy.models.util.solvers.pdipm import spbatch as pdipm_spb
